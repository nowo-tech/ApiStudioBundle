...
/**
 * Applies Doctrine schema create/update SQL for API Studio entities only.
 */
final class SchemaSyncService
{
    private const ENTITY_NAMESPACE_PREFIX = 'Nowo\\ApiStudioBundle\\Entity\\';
    ...
    {
        $codes = ['42P07', '42701', '42S01', '1050', '1826'];
        $walk  = $exception;
