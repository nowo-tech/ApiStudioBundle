...
We take the security of ApiStudioBundle seriously. If you believe you have found a security vulnerability, please report it privately:
...
- Type of issue (e.g., SSRF, auth bypass, secret exposure, XSS, etc.)
